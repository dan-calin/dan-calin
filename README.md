...
| **[Shared Agent Memory](https://github.com/dan-calin/shared-agent-memory)** | A local coordination layer that gives AI coding agents shared memory, file-claim awareness, and safer multi-agent workflows across Claude Code and Codex. | MCP · Agent orchestration · Developer tooling · Node.js |
...
| **[Miko](https://github.com/dan-calin/miko-voice-assistant)** | A Windows voice assistant powered by Gemini Live that can work with the PC, Discord, the web, and local files. It also exposes tools that other agents can call. | Voice AI · Tool calling · FastAPI · Automation · Python |
